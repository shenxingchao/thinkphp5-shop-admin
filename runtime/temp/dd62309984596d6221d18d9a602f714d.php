<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:61:"D:\phpStudy\admin/application/admin\view\goods\goods_lst.html";i:1504165578;s:59:"D:\phpStudy\admin/application/admin\view\public\header.html";i:1504167331;s:57:"D:\phpStudy\admin/application/admin\view\public\menu.html";i:1499759447;s:59:"D:\phpStudy\admin/application/admin\view\public\footer.html";i:1504165666;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<section class="content">
    ...
    <table class="table table-bordered table-hover" >
        ...
        <td><img src="<?php echo $data['goods_thumb_img']; ?>" alt="<?php echo $data['goods_name']; ?>" title="<?php echo $data['goods_name']; ?>" width="50"  height="50"></td>
            ...
            <td><?php if($data['is_on_sale'] == 1): ?><i class="glyphicon glyphicon-ok green"></i><?php else: ?><i class="glyphicon glyphicon-remove red"></i><?php endif; ?></td>
            <td>
