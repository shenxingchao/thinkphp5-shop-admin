<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:66:"D:\phpStudy\admin/application/admin\view\admin\admin_role_add.html";i:1502070508;s:59:"D:\phpStudy\admin/application/admin\view\public\header.html";i:1503449791;s:57:"D:\phpStudy\admin/application/admin\view\public\menu.html";i:1499759447;s:59:"D:\phpStudy\admin/application/admin\view\public\footer.html";i:1503390357;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <tr>
                    ...
                    <td class="col-sm-10 col-xs-10 group_content">
                        <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub_data): $mod = ($i % 2 );++$i;?>
                            <label><input class="privilege_checkbox" type="checkbox" name="privilege_id[]" value="<?php echo $sub_data['id']; ?>"><span class="privilege_span"><?php echo $sub_data['privilege_name']; ?></span></label>&nbsp;&nbsp;
