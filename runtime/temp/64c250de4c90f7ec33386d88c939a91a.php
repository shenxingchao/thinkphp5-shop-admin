<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"D:\phpStudy\admin/application/admin\view\goods\goods_type_edit.html";i:1504158989;s:59:"D:\phpStudy\admin/application/admin\view\public\header.html";i:1504167331;s:57:"D:\phpStudy\admin/application/admin\view\public\menu.html";i:1499759447;s:59:"D:\phpStudy\admin/application/admin\view\public\footer.html";i:1504165666;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="form-horizontal col-sm-8 col-sm-offset-2" action="/admin/goods/goods_type_edit" method="post" enctype="multipart/form-data">
    <div class="box-body">
        <div class="form-group">
            <label for="type_name" class="col-sm-2 control-label">商品类型名称</label>
            <div class="col-sm-6">
                <input type="text" class="form-control" name="type_name" id="type_name" placeholder="商品类型名称" value="<?php echo $type_info['type_name']; ?>">
            </div>
...
<script type="text/javascript">
    $(function () {
        $('.edit_btn').on('click',function () {
            //1.提交前验证
            if($('#type_name').val() == ""){
                showMsg('商品类型名称不能为空','type_name',1000);
                return false;
            }
            else{
